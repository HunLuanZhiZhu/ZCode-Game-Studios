...
`.zcode/docs/technical-preferences.md`, because you've filled them in with
...
**New files to add:**
```
.zcode/skills/art-bible/SKILL.md
.zcode/skills/asset-spec/SKILL.md
.zcode/docs/director-gates.md
```

**Existing files to overwrite (no user content):**
```
.zcode/skills/brainstorm/SKILL.md
.zcode/skills/gate-check/SKILL.md
.zcode/skills/team-level/SKILL.md
.zcode/skills/team-narrative/SKILL.md
.zcode/skills/design-system/SKILL.md
.zcode/docs/workflow-catalog.yaml
README.md
UPGRADING.md
```
...
**New files to add:**
```
.zcode/skills/vertical-slice/SKILL.md
CONTRIBUTING.md
SECURITY.md
```

**Existing files to overwrite (no user content):**
- All files under `.zcode/skills/` modified in the commit range (skill audit + AskUserQuestion widgets + `--review` argument-hints)
- `ccgs-studio-hooks/hooks/log-agent.sh` (fix #21)
...
| Category | Changes |
|----------|---------|
| **New system** | Director gates — named review checkpoints shared across all workflow skills. Defined in `.zcode/docs/director-gates.md` |
...
**New files to add:**
```
.zcode/agents/godot-csharp-specialist.md
.zcode/docs/director-gates.md
```
...
```
.zcode/skills/brainstorm/SKILL.md
.zcode/skills/map-systems/SKILL.md
.zcode/skills/design-system/SKILL.md
.zcode/skills/architecture-decision/SKILL.md
.zcode/skills/create-architecture/SKILL.md
.zcode/skills/create-epics/SKILL.md
.zcode/skills/create-stories/SKILL.md
.zcode/skills/sprint-plan/SKILL.md
.zcode/skills/milestone-review/SKILL.md
.zcode/skills/playtest-report/SKILL.md
.zcode/skills/prototype/SKILL.md
.zcode/skills/story-done/SKILL.md
.zcode/skills/gate-check/SKILL.md
.zcode/skills/start/SKILL.md
.zcode/skills/quick-design/SKILL.md
.zcode/skills/setup-engine/SKILL.md
README.md
...
`.zcode/docs/director-gates.md`. Gates are identified by domain prefix and name
...
2. If you're mid-project, review `.zcode/docs/director-gates.md` to understand which gates apply to your current phase.
...
**New files to add:**
```
.zcode/skills/consistency-check/SKILL.md
```

**Existing files to overwrite (no user content):**
```
.zcode/skills/team-combat/SKILL.md      ← no-arg guard, verdict keywords, gate improvements
.zcode/skills/team-narrative/SKILL.md   ← no-arg guard, verdict keywords, gate improvements
.zcode/skills/team-ui/SKILL.md          ← no-arg guard, verdict keywords, gate improvements
.zcode/skills/team-release/SKILL.md     ← no-arg guard, verdict keywords, NO-GO path
.zcode/skills/team-polish/SKILL.md      ← no-arg guard, verdict keywords, gate improvements
.zcode/skills/team-audio/SKILL.md       ← no-arg guard, verdict keywords, gate improvements
.zcode/skills/team-level/SKILL.md       ← no-arg guard, verdict keywords, adjacent area checks
.zcode/skills/team-live-ops/SKILL.md    ← no-arg guard, verdict keywords, ethics enforcement
.zcode/skills/team-qa/SKILL.md          ← no-arg guard, verdict keywords, gate improvements
.zcode/skills/map-systems/SKILL.md      ← verdict keywords
.zcode/skills/create-epics/SKILL.md     ← "May I write" protocol fix, verdict keywords
.zcode/skills/create-stories/SKILL.md   ← verdict keywords
.zcode/agents/game-designer.md          ← genre-agnostic language
.zcode/agents/systems-designer.md       ← genre-agnostic language
.zcode/agents/economy-designer.md       ← genre-agnostic language
.zcode/agents/live-ops-designer.md      ← genre-agnostic language
```
...
**New files to add:**
```
.zcode/skills/ux-design/SKILL.md
.zcode/skills/ux-review/SKILL.md
.zcode/skills/help/SKILL.md
.zcode/skills/quick-design/SKILL.md
.zcode/skills/review-all-gdds/SKILL.md
.zcode/skills/story-readiness/SKILL.md
.zcode/skills/story-done/SKILL.md
.zcode/skills/sprint-status/SKILL.md
.zcode/skills/adopt/SKILL.md
.zcode/skills/create-architecture/SKILL.md
.zcode/skills/create-control-manifest/SKILL.md
.zcode/skills/create-epics/SKILL.md
.zcode/skills/create-stories/SKILL.md
.zcode/skills/dev-story/SKILL.md
.zcode/skills/propagate-design-change/SKILL.md
.zcode/skills/content-audit/SKILL.md
.zcode/skills/architecture-review/SKILL.md
.zcode/skills/qa-plan/SKILL.md
.zcode/skills/smoke-check/SKILL.md
.zcode/skills/soak-test/SKILL.md
.zcode/skills/regression-suite/SKILL.md
.zcode/skills/test-setup/SKILL.md
.zcode/skills/test-helpers/SKILL.md
.zcode/skills/test-evidence-review/SKILL.md
.zcode/skills/test-flakiness/SKILL.md
.zcode/skills/skill-test/SKILL.md
.zcode/skills/bug-triage/SKILL.md
.zcode/skills/team-live-ops/SKILL.md
.zcode/skills/team-qa/SKILL.md
ccgs-studio-hooks/hooks/log-agent-stop.sh
ccgs-studio-hooks/hooks/notify.sh
ccgs-studio-hooks/hooks/post-compact.sh
ccgs-studio-hooks/hooks/validate-skill-change.sh
.zcode/docs/workflow-catalog.yaml
.zcode/docs/templates/ux-spec.md
.zcode/docs/templates/hud-design.md
.zcode/docs/templates/accessibility-requirements.md
.zcode/docs/templates/interaction-pattern-library.md
.zcode/docs/templates/player-journey.md
.zcode/docs/templates/difficulty-curve.md
design/AGENTS.md
src/AGENTS.md
docs/AGENTS.md
```
...
.zcode/skills/team-ui/SKILL.md
.zcode/skills/story-readiness/SKILL.md
.zcode/skills/story-done/SKILL.md
.zcode/docs/templates/game-design-document.md    ← adds Game Feel section
README.md
docs/WORKFLOW-GUIDE.md
UPGRADING.md
```
...
```
.zcode/agents/prototyper.md         ← adds isolation: worktree
.zcode/agents/art-director.md       ← adds memory: project
.zcode/agents/audio-director.md     ← adds memory: project
.zcode/agents/economy-designer.md   ← adds memory: project
.zcode/agents/game-designer.md      ← adds memory: project
.zcode/agents/gameplay-programmer.md ← adds memory: project
.zcode/agents/lead-programmer.md    ← adds memory: project
.zcode/agents/level-designer.md     ← adds memory: project
.zcode/agents/narrative-director.md ← adds memory: project
.zcode/agents/systems-designer.md   ← adds memory: project
.zcode/agents/technical-artist.md   ← adds memory: project
.zcode/agents/ui-programmer.md      ← adds memory: project
.zcode/agents/ux-designer.md        ← adds memory: project
.zcode/agents/world-builder.md      ← adds memory: project
```
...
- `validate-skill-change.sh` — `PostToolUse` event filtered to `.zcode/skills/` writes
...
- `catalog` — checks that all skills in `.zcode/skills/` are indexed in the catalog
...
Skills are now explicitly assigned to Haiku, Sonnet, or Opus tiers based on task complexity. Read-only status checks use Haiku; complex multi-document synthesis uses Opus; everything else defaults to Sonnet. Tier assignments are documented in `.zcode/docs/coordination-rules.md`.

#### Directory AGENTS.md Files

Three new directory-scoped AGENTS.md files (`design/`, `src/`, `docs/`) provide path-specific instructions to agents working in those directories. These load automatically when Claude Code reads files in that directory.

---

### After Upgrading

1. **Verify new hooks** are registered in `.zcode/settings.json` — check for all four: `log-agent-stop.sh`, `notify.sh`, `post-compact.sh`, `validate-skill-change.sh`.
...
| **New files** | `.zcode/statusline.sh`, `.zcode/settings.json` statusline config |
...
**Existing files to overwrite (no user content):**
```
.zcode/skills/map-systems/SKILL.md      ← was design-systems/SKILL.md
.zcode/skills/gate-check/SKILL.md
.zcode/skills/brainstorm/SKILL.md
.zcode/skills/start/SKILL.md
.zcode/skills/design-review/SKILL.md
.zcode/skills/project-stage-detect/SKILL.md
.zcode/skills/setup-engine/SKILL.md
ccgs-studio-hooks/hooks/log-agent.sh
ccgs-studio-hooks/hooks/validate-commit.sh
README.md
docs/WORKFLOW-GUIDE.md
UPGRADING.md
```
...
```
.zcode/skills/design-systems/   ← entire directory; replaced by map-systems/
```
...
`.zcode/statusline.sh`. If you haven't customized `settings.json`, overwriting
is safe. Otherwise, add this block manually:

```json
"statusLine": {
  "script": ".zcode/statusline.sh"
}
```
...
`.zcode/statusline.sh` displays a 7-stage production pipeline breadcrumb in
...
1. **Delete the old skill directory:**
   ```bash
   rm -rf .zcode/skills/design-systems/
   ```
...
3. **Verify hook execution** still works:
   ```bash
   bash ccgs-studio-hooks/hooks/log-agent.sh '{}' '{}'
   bash ccgs-studio-hooks/hooks/validate-commit.sh '{}' '{}'
   ```
...
.zcode/skills/map-systems/SKILL.md
.zcode/skills/design-system/SKILL.md
.zcode/docs/templates/systems-index.md
.zcode/docs/templates/collaborative-protocols/design-agent-protocol.md
.zcode/docs/templates/collaborative-protocols/implementation-agent-protocol.md
.zcode/docs/templates/collaborative-protocols/leadership-agent-protocol.md
ccgs-studio-hooks/hooks/detect-gaps.sh
ccgs-studio-hooks/hooks/session-start.sh
...
.zcode/skills/project-stage-detect/SKILL.md
.zcode/skills/setup-engine/SKILL.md
.zcode/skills/team-audio/SKILL.md
.zcode/skills/team-combat/SKILL.md
.zcode/skills/team-level/SKILL.md
.zcode/skills/team-narrative/SKILL.md
.zcode/skills/team-polish/SKILL.md
.zcode/skills/team-release/SKILL.md
.zcode/skills/team-ui/SKILL.md
ccgs-studio-hooks/hooks/log-agent.sh
ccgs-studio-hooks/hooks/pre-compact.sh
ccgs-studio-hooks/hooks/session-stop.sh
ccgs-studio-hooks/hooks/validate-assets.sh
ccgs-studio-hooks/hooks/validate-commit.sh
ccgs-studio-hooks/hooks/validate-push.sh
.zcode/rules/design-docs.md
.zcode/docs/hooks-reference.md
.zcode/docs/skills-reference.md
.zcode/docs/quick-start.md
...
**Agent files to overwrite** (if you haven't written custom prompts into them):
```
.zcode/agents/art-director.md
.zcode/agents/audio-director.md
.zcode/agents/creative-director.md
.zcode/agents/economy-designer.md
.zcode/agents/game-designer.md
.zcode/agents/level-designer.md
.zcode/agents/live-ops-designer.md
.zcode/agents/narrative-director.md
.zcode/agents/producer.md
.zcode/agents/systems-designer.md
.zcode/agents/technical-director.md
.zcode/agents/ux-designer.md
.zcode/agents/world-builder.md
.zcode/agents/writer.md
```
...
#### `.zcode/docs/templates/game-concept.md`
...
4. **Test hook execution** — if you're on Windows, verify the new hooks run
   ...
   ```bash
   bash ccgs-studio-hooks/hooks/detect-gaps.sh '{}' '{}'
   bash ccgs-studio-hooks/hooks/session-start.sh '{}' '{}'
   ```
