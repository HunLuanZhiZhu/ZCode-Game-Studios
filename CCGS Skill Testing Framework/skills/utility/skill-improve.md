...
**Fixture:**
- `.zcode/skills/some-skill/SKILL.md` has 2 static failures:
...
4. Skill asks "May I write improvements to `.zcode/skills/some-skill/SKILL.md`?"
...
**Fixture:**
- `.zcode/skills/some-skill/SKILL.md` has 1 static failure (missing handoff)
...
**Fixture:**
- `.zcode/skills/gate-check/SKILL.md` is a gate skill with 1 static failure
...
4. "May I write improvements to `.zcode/skills/gate-check/SKILL.md`?"
...
**Fixture:**
- `.zcode/skills/brainstorm/SKILL.md` has no static failures
