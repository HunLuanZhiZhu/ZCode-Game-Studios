...
- **audit**: Produces a coverage table of all skills in `.zcode/skills/` and
  all agents in `.zcode/agents/`, showing which have spec files and which do not.
...
**Fixture:**
- `.zcode/skills/brainstorm/SKILL.md` exists and is well-formed:
...
**Expected behavior:**
1. Skill reads `.zcode/skills/brainstorm/SKILL.md`
...
**Fixture:**
- `.zcode/skills/some-skill/SKILL.md` has `Write` in `allowed-tools` frontmatter
...
- `.zcode/skills/gate-check/SKILL.md` exists
...
**Fixture:**
- `.zcode/skills/` contains 72+ skill directories
- `.zcode/agents/` contains 49+ agent files
- `tests/skills/` contains spec files for a subset of skills

**Input:** `/skill-test audit`

**Expected behavior:**
1. Skill enumerates all skills in `.zcode/skills/` and all agents in `.zcode/agents/`
...
- `.zcode/skills/gate-check/SKILL.md` is a gate skill
