...
- [ ] Phase 2 includes spawning the primary engine specialist (read from `.zcode/docs/technical-preferences.md`)
...
- Engine is configured in `.zcode/docs/technical-preferences.md` (Engine Specialists section filled)
...
**Fixture:**
- `.zcode/docs/technical-preferences.md` has Engine Specialists section populated (e.g., Primary: godot-specialist)
...
2. Skill reads `.zcode/docs/technical-preferences.md` Engine Specialists section to identify the primary engine specialist agent type
...
**Assertions:**
- [ ] Engine specialist agent type is read from `.zcode/docs/technical-preferences.md` — not hardcoded
