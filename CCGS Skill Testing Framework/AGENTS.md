# CCGS Skill Testing Framework — Agent Instructions
...
2. Read the skill at `.zcode/skills/[name]/SKILL.md`
...
Nothing in `.zcode/` imports from here. Deleting this folder has no effect on the
